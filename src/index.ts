...
import { AppRegistry, NativeModules, Platform, NativeEventEmitter, DeviceEventEmitter, TaskProvider } from 'react-native'
// @ts-ignore
...
export const usePlaybackState = (): State => {
  ...
  useEffect(() => {
      const subscription = emitter.addListener(Event.State, setState)
